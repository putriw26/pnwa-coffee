...
<body>
    ...
    <div class="container">
        ...
        <a href="index.php" 
           style="background-color: #A8D5BA; border: 1px solid #A8D5BA; color: white; padding: 6px 12px; border-radius: 5px; text-decoration: none; display: inline-block; font-weight: bold;">
            Kembali
        </a>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            <button 
                                name="tambah"
                                style="background-color: #f8c7cc; border: 1px solid #f8c7cc; color: white; padding: 6px 12px; border-radius: 5px;">
                                Tambah
                            </button>
                        </td>
